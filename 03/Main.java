    ...
    public static void main(String[] args) {
        ...
        switch (name){
            case "Не скажу":
                ...
                break;
            case "Нет":
                System.out.println("Что значит нет? :с\nУф, ладно, как хочешь, но я буду звать тебя Безымяшкой :3\nА меня кстати все зовут Программой ( ͡° ͜ʖ ͡°)\n");
                name = "Безымяшка";
                break;
            default:
                System.out.println("Очень приятно, "+name+", а меня зовут Программа ( ͡° ͜ʖ ͡°)\n");
                break;
        }

        String[] AstroSign = {"Овен", "Телец", "Близнецы", "Рак", "Лев","Дева","Весы","Скорпион","Стрелец","Козерог","Водолей","Рыбы"};
        ...
        String[] FavFood = {"Чипсы","Сладкое","Шоколадки","Карамельки","Мамину еду","Мясо","Тортики","Булочки","Пиццу","Рыбу","Курочку","Бургеры","Мороженное",};
        i=rand.nextInt(13);
